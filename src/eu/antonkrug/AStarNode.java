...
public class AStarNode {
	 ...
	 * @param destination
	 */
	public AStarNode(Point parent, int previousCost, int currentX, int currentY,
	 ...
	 * @param destination
	 */
	public AStarNode(Point parent, int previousCost, Point current, List<Point> destinations)
			throws Exception {
