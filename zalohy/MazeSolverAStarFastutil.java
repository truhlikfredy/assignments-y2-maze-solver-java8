...
public class MazeSolverAStarFastutil implements MazeSolver {
	 ...
	 */
	public MazeSolverAStarFastutil(Maze maze) throws Exception {
	...
	public List<Point> backTracePath() {
		...
		Optional<Point> destination = destinations.stream().filter(visitedAlready::containsKey)
				.findFirst();
