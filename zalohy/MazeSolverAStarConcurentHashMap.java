...
/**
 * Multithreaded implementation of A* using hash maps as main datastructure to 
 * hold open and closed lists
 * 
 * 
 * @author Anton Krug
 * @date 2015/02/22
...
public class MazeSolverAStarConcurentHashMap implements MazeSolver {
	 ...
	 */
	public MazeSolverAStarConcurentHashMap(Maze maze) throws Exception {
